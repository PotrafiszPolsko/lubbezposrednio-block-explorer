...
import { BLOCK_DETAILS_TABS } from "../constants";

interface BlockDetailsTabListProps {}

export const BlockDetailsTabList: React.FC<BlockDetailsTabListProps> = ({}) => {
  const t = useTranslations();

  return (
    <>
      <Tab.List className="flex gap-10 w-full flex-nowrap overflow-auto lg:gap-20">
        {BLOCK_DETAILS_TABS.map((item, idx) => (
